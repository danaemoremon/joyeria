...
Alta y edición de productos de joyería con validaciones de campos.

Seguridad de Precios: Restricción de permisos donde el cambio de precios es exclusivo para el perfil de clientes autorizados.

Implementación ORM: Gestión de la capa de datos mediante un mapeo objeto-relacional (ORM) para una manipulación de base de datos más limpia y segura.

🔍 Consultas e Informes

Visualización de inventario en tablas dinámicas y organizadas.

Control de stock y precios de artículos en tiempo real.

Estructura profesional mediante carpeta public_html y separación de lógica en el directorio src.
